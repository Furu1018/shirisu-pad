...
(async () => {
    ...
    const nameFrom = (img) => {
        ...
        return { name, texts };   // ★ 候補は全部保存 (切ると「外れたら手動マッピング」の保険が崩れる)
    };
    const collect = () => {
