...
const IMAGE_PROMPTS = {
  ...
  season_announce: [
    ...
    "- bosses: 5体配列。各 position(1-5)/name/weakness/tier",
    "",
    "weakness は以下から正確に判別 (各ボスの「弱点」ラベル下にあるカラーアイコンを見る):",
    "  灼熱  → 赤い炎マーク (オレンジ赤の三角炎)",
    "  水冷  → 青い水滴マーク (青いしずく)",
    "  電撃  → 紫の稲妻マーク (紫の稲妻)",
    "  鉄甲  → 橙の六角形マーク (蜂の巣のような六角形)",
    "  風圧  → 緑の風マーク (緑の旋風)",
    "アイコンの色を頼りに判定。文字の小さい『弱点』ラベル付近にある色付きアイコンが該当。",
    "",
    "tier は以下から:",
    "  tyrant   → タイラント級",
    "  lord     → ロード級",
    "  heretic  → ヘレティック級 (HPはタイラント級と同等扱い)",
    "",
    "出力はJSONのみ、コードフェンス禁止。",
  ].join("\n"),
};
